...
use Okta\Logs\SecurityContext;
use PHPUnit\Framework\TestCase;

class SecurityContextTest extends BaseUnitTestCase
{
    protected $properties;

    /** @var  \Okta\Logs\SecurityContext */
    protected $testable;

    protected $model = '/Logs/securityContext.json';
    protected $modelType = \Okta\Logs\SecurityContext::class;
