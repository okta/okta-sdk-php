...
use Okta\Logs\LogTransaction;
use PHPUnit\Framework\TestCase;

class LogTransactionTest extends BaseUnitTestCase
{
    protected $properties;

    /** @var  \Okta\Logs\LogTransaction */
    protected $testable;

    protected $model = '/Logs/transaction.json';
    protected $modelType = \Okta\Logs\LogTransaction::class;
