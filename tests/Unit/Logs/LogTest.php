...
class LogTest extends BaseUnitTestCase
{
    ...
    protected $modelType = \Okta\Logs\Log::class;
    ...
    {
        $this->assertInstanceOf(\Okta\Logs\Actor::class, $this->testable->getActor());
        $this->assertInstanceOf(\Okta\Logs\Actor::class, $this->testable->actor);
    }

    /** @test */
    public function client_is_accessible()
    {
        $this->assertInstanceOf(\Okta\Logs\Client::class, $this->testable->getClient());
        $this->assertInstanceOf(\Okta\Logs\Client::class, $this->testable->client);
    }
    ...
    {
        $this->assertInstanceOf(\Okta\Logs\Outcome::class, $this->testable->getOutcome());
        $this->assertInstanceOf(\Okta\Logs\Outcome::class, $this->testable->outcome);
    }
    ...
    {
        $this->assertInstanceOf(\Okta\Logs\Transaction::class, $this->testable->getTransaction());
        $this->assertInstanceOf(\Okta\Logs\Transaction::class, $this->testable->transaction);
    }

    /** @test */
    public function debug_context_is_accessible()
    {
        $this->assertInstanceOf(\Okta\Logs\DebugContext::class, $this->testable->getDebugContext());
        $this->assertInstanceOf(\Okta\Logs\DebugContext::class, $this->testable->debugContext);
    }
    ...
    {
        $this->assertInstanceOf(\Okta\Logs\SecurityContext::class, $this->testable->getSecurityContext());
        $this->assertInstanceOf(\Okta\Logs\SecurityContext::class, $this->testable->securityContext);
    }

    /** @test */
    public function authentication_context_is_accessible()
    {
        $this->assertInstanceOf(\Okta\Logs\AuthenticationContext::class, $this->testable->getAuthenticationContext());
        $this->assertInstanceOf(\Okta\Logs\AuthenticationContext::class, $this->testable->authenticationContext);
    }
