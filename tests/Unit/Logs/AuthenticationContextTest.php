...
use Okta\Logs\AuthenticationContext;
use PHPUnit\Framework\TestCase;

class AuthenticationContextTest extends BaseUnitTestCase
{
    protected $properties;

    /** @var  \Okta\Logs\AuthenticationContext */
    protected $testable;

    protected $model = '/Logs/authenticationContext.json';
    protected $modelType = \Okta\Logs\AuthenticationContext::class;
    
    /** @test */
    public function issuer_is_accessible()
    {
        $this->assertInstanceOf(\Okta\Logs\Issuer::class, $this->testable->getIssuer());
        $this->assertInstanceOf(\Okta\Logs\Issuer::class, $this->testable->issuer);
    }
