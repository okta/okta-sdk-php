...
use Okta\Logs\GeographicalContext;
use PHPUnit\Framework\TestCase;

class GeographicalContextTest extends BaseUnitTestCase
{
    protected $properties;

    /** @var  \Okta\Logs\GeographicalContext */
    protected $testable;

    protected $model = '/Logs/geographicalContext.json';
    protected $modelType = \Okta\Logs\GeographicalContext::class;
    ...
    {
        $this->assertInstanceOf(\Okta\Logs\Geolocation::class, $this->testable->getGeolocation());
        $this->assertInstanceOf(\Okta\Logs\Geolocation::class, $this->testable->geolocation);
    }
