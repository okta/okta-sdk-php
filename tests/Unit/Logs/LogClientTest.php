...
class LogClientTest extends BaseUnitTestCase
{
    ...
    /** @var  \Okta\Logs\Client */
    protected $testable;

    protected $model = '/Logs/client.json';
    protected $modelType = \Okta\Logs\Client::class;
    ...
    {
        $this->assertEquals($this->properties->userAgent, $this->testable->getUserAgent());
        $this->assertEquals($this->properties->userAgent, $this->testable->userAgent);
    }

    /** @test */
    public function geographical_context_is_accessible()
    {
        $this->assertInstanceOf(\Okta\Logs\GeographicalContext::class, $this->testable->getGeographicalContext());
        $this->assertInstanceOf(\Okta\Logs\GeographicalContext::class, $this->testable->geographicalContext);
    }
