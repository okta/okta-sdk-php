...
class HardwareFactorTest extends BaseTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        static::$properties = json_decode(file_get_contents(__DIR__ . '/../../models/UserFactors/hardwareFactor.json'));
        ...
        self::$testable = new \Okta\UserFactors\HardwareFactor(null, $class);
    }
