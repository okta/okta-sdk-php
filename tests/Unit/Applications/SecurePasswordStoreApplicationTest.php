...
use Okta\Applications\SecurePasswordStoreApplication;
use PHPUnit\Framework\TestCase;

class SecurePasswordStoreApplicationTest extends BaseUnitTestCase
{
    protected $properties;

    /** @var  \Okta\Applications\SecurePasswordStoreApplication */
    protected $testable;

    protected $model = '{"settings": {"test":"this"}, "credentials": {"test":"this"}}';
    protected $modelType = \Okta\Applications\SecurePasswordStoreApplication::class;

    /** @test */
    public function settings_is_accessible()
    {
        $this->assertInstanceOf(\Okta\Applications\SecurePasswordStoreApplicationSettings::class,
            $this->testable->getSettings());
        $this->assertInstanceOf(\Okta\Applications\SecurePasswordStoreApplicationSettings::class,
            $this->testable->settings);
    }
