...
class AutoLoginApplicationTest extends BaseUnitTestCase
{
    protected $properties;

    /** @var  \Okta\Applications\AutoLoginApplication */
    protected $testable;

    protected $model = '{"settings": {"test":"this"}, "credentials": {"test":"this"}}';
    protected $modelType = \Okta\Applications\AutoLoginApplication::class;

    /** @test */
    public function settings_is_accessible()
    {
        $this->assertInstanceOf(\Okta\Applications\AutoLoginApplicationSettings::class, $this->testable->getSettings());
        $this->assertInstanceOf(\Okta\Applications\AutoLoginApplicationSettings::class, $this->testable->settings);
    }
