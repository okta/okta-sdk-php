...
use Okta\Sessions\SessionAuthority;
use PHPUnit\Framework\TestCase;

class SessionAuthorityTest extends BaseUnitTestCase
{
    protected $properties;

    /** @var  \Okta\Sessions\SessionAuthority */
    protected $testable;

    protected $model = '{"id": "abc123", "type": "ACTIVE"}';
    protected $modelType = \Okta\Sessions\SessionAuthority::class;
