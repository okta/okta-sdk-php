...
class TrustedOrigin extends \Okta\Resource\AbstractResource
{
     ...
     * Success
     */
    function create() : \Okta\TrustedOrigin\TrustedOrigin 
    {
        ...
        $body = $this
                ...
                ->setRequestBody($this)
                ->executeRequest();
        return new \Okta\TrustedOrigin\TrustedOrigin(null, $body);
    }
    /**
     * Success
     */
    function read($trustedOriginId) : \Okta\TrustedOrigin\TrustedOrigin 
    {
        $uri = $this->getDataStore()->buildUri(
     ...
     * Success
     */
    function update() : \Okta\TrustedOrigin\TrustedOrigin 
    {
        $uri = $this->getDataStore()->buildUri(
            "/api/v1/trustedOrigins/".$this->id.""
        );
        $body = $this
                ->getDataStore()
