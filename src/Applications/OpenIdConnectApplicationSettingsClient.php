...
class OpenIdConnectApplicationSettingsClient extends \Okta\Resource\AbstractResource
{
    ...
    * Set the issuer_mode.
    *
    * @param mixed $issuer_mode The value to set.
    * @return self
    */
    ...
    */
    ...
    /**
     * Get the initiate_login_uri.
     *
     * @return string
     */
    public function getInitiateLoginUri()
    {
        return $this->getProperty(self::INITIATE_LOGIN_URI);
    }

    /**
    * Set the initiate_login_uri.
    *
    * @param mixed $initiate_login_uri The value to set.
    * @return self
    */
    ...
    /**
     * Get the post_logout_redirect_uris.
     *
     * @return array
     */
    public function getPostLogoutRedirectUris()
    {
        return $this->getProperty(self::POST_LOGOUT_REDIRECT_URIS);
    }

    /**
    * Set the post_logout_redirect_uris.
    *
    * @param mixed $post_logout_redirect_uris The value to set.
    * @return self
    */
