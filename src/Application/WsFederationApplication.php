...
class WsFederationApplication extends \Okta\Application\Application
{
    const NAME = 'name';
     ...
     * @return self
     */
    function setName($name) : WsFederationApplication
    {
        $this->setProperty(
            self::NAME,
            $name
     ...
     * @return self
     */
    function setSettings(\Okta\Application\WsFederationApplicationSettings $settings) : WsFederationApplication
    {
     ...
     * @return self
     */
    function setAccessibility(\Okta\Application\ApplicationAccessibility $accessibility) : WsFederationApplication
    {
        $this->setResourceProperty(
            self::ACCESSIBILITY,
            $accessibility
     ...
     * @return self
     */
    function setCredentials(\Okta\Application\ApplicationCredentials $credentials) : WsFederationApplication
    {
        $this->setResourceProperty(
            self::CREDENTIALS,
            $credentials
     ...
     * @return self
     */
    function setFeatures($features) : WsFederationApplication
    {
        $this->setProperty(
            self::FEATURES,
            $features
     ...
     * @return self
     */
    function setLabel($label) : WsFederationApplication
    {
        $this->setProperty(
            self::LABEL,
            $label
     ...
     * @return self
     */
    function setLicensing(\Okta\Application\ApplicationLicensing $licensing) : WsFederationApplication
    {
        $this->setResourceProperty(
            self::LICENSING,
            $licensing
     ...
     * @return self
     */
    function setProfile($profile) : WsFederationApplication
    {
        $this->setProperty(
            self::PROFILE,
            $profile
     ...
     * @return self
     */
    function setSignOnMode(\Okta\Application\ApplicationSignOnMode $signOnMode) : WsFederationApplication
    {
     ...
     * @return self
     */
    function setVisibility(\Okta\Application\ApplicationVisibility $visibility) : WsFederationApplication
    {
        $this->setResourceProperty(
            self::VISIBILITY,
            $visibility
     ...
     * @return \Okta\Application\WsFederationApplicationSettings
     */
    function getSettings(array $options = []) : \Okta\Application\WsFederationApplicationSettings
    {
        return $this->getResourceProperty(
            self::SETTINGS,
            \Okta\Application\WsFederationApplicationSettings::class,
            $options
        );
    }
