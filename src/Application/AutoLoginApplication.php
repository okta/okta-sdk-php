...
class AutoLoginApplication extends \Okta\Application\Application
{
     ...
     * @return self
     */
    function setAccessibility(\Okta\Application\ApplicationAccessibility $accessibility) : AutoLoginApplication
    {
        $this->setResourceProperty(
            self::ACCESSIBILITY,
            $accessibility
     ...
     * @return self
     */
    function setFeatures($features) : AutoLoginApplication
    {
        $this->setProperty(
            self::FEATURES,
            $features
     ...
     * @return self
     */
    function setLabel($label) : AutoLoginApplication
    {
        $this->setProperty(
            self::LABEL,
            $label
     ...
     * @return self
     */
    function setLicensing(\Okta\Application\ApplicationLicensing $licensing) : AutoLoginApplication
    {
        $this->setResourceProperty(
            self::LICENSING,
            $licensing
     ...
     * @return self
     */
    function setProfile($profile) : AutoLoginApplication
    {
        $this->setProperty(
            self::PROFILE,
            $profile
     ...
     * @return self
     */
    function setVisibility(\Okta\Application\ApplicationVisibility $visibility) : AutoLoginApplication
    {
        $this->setResourceProperty(
            self::VISIBILITY,
            $visibility
