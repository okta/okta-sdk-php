...
class OAuth2RefreshToken extends \Okta\Resource\AbstractResource
{
    const ID = 'id';
    const LINKS = '_links';
    const ISSUER = 'issuer';
     ...
     * @return self
     */
    function setIssuer($issuer) : OAuth2RefreshToken
    {
        $this->setProperty(
            self::ISSUER,
            $issuer
     ...
     * @return self
     */
    function setScopes($scopes) : OAuth2RefreshToken
    {
        $this->setProperty(
            self::SCOPES,
            $scopes
     ...
     * @return self
     */
    function setStatus($status) : OAuth2RefreshToken
    {
        $this->setProperty(
            self::STATUS,
            $status
     ...
     * @return self
     */
    function setUserId($userId) : OAuth2RefreshToken
    {
        $this->setProperty(
            self::USER_ID,
            $userId
     ...
     * @return self
     */
    function setClientId($clientId) : OAuth2RefreshToken
    {
        $this->setProperty(
            self::CLIENT_ID,
            $clientId
     ...
     * @return self
     */
    function setCreatedBy(\Okta\Application\OAuth2Actor $createdBy) : OAuth2RefreshToken
    {
