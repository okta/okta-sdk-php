...
class OpenIdConnectApplication extends \Okta\Application\Application
{
     ...
     * @return self
     */
    function setAccessibility(\Okta\Application\ApplicationAccessibility $accessibility) : OpenIdConnectApplication
    {
        $this->setResourceProperty(
            self::ACCESSIBILITY,
            $accessibility
     ...
     * @return self
     */
    function setFeatures($features) : OpenIdConnectApplication
    {
        $this->setProperty(
            self::FEATURES,
            $features
     ...
     * @return self
     */
    function setLabel($label) : OpenIdConnectApplication
    {
        $this->setProperty(
            self::LABEL,
            $label
     ...
     * @return self
     */
    function setLicensing(\Okta\Application\ApplicationLicensing $licensing) : OpenIdConnectApplication
    {
        $this->setResourceProperty(
            self::LICENSING,
            $licensing
     ...
     * @return self
     */
    function setProfile($profile) : OpenIdConnectApplication
    {
        $this->setProperty(
            self::PROFILE,
            $profile
     ...
     * @return self
     */
    function setVisibility(\Okta\Application\ApplicationVisibility $visibility) : OpenIdConnectApplication
    {
        $this->setResourceProperty(
            self::VISIBILITY,
            $visibility
