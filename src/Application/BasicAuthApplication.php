...
class BasicAuthApplication extends \Okta\Application\Application
{
    const NAME = 'name';
     ...
     * @return self
     */
    function setName($name) : BasicAuthApplication
    {
        $this->setProperty(
            self::NAME,
            $name
     ...
     * @return self
     */
    function setSettings(\Okta\Application\BasicApplicationSettings $settings) : BasicAuthApplication
    {
     ...
     * @return self
     */
    function setCredentials(\Okta\Application\SchemeApplicationCredentials $credentials) : BasicAuthApplication
    {
        $this->setResourceProperty(
            self::CREDENTIALS,
            $credentials
     ...
     * @return self
     */
    function setAccessibility(\Okta\Application\ApplicationAccessibility $accessibility) : BasicAuthApplication
    {
        $this->setResourceProperty(
            self::ACCESSIBILITY,
            $accessibility
     ...
     * @return self
     */
    function setFeatures($features) : BasicAuthApplication
    {
        $this->setProperty(
            self::FEATURES,
            $features
     ...
     * @return self
     */
    function setLabel($label) : BasicAuthApplication
    {
        $this->setProperty(
            self::LABEL,
            $label
     ...
     * @return self
     */
    function setLicensing(\Okta\Application\ApplicationLicensing $licensing) : BasicAuthApplication
    {
        $this->setResourceProperty(
            self::LICENSING,
            $licensing
     ...
     * @return self
     */
    function setProfile($profile) : BasicAuthApplication
    {
        $this->setProperty(
            self::PROFILE,
            $profile
     ...
     * @return self
     */
    function setSignOnMode(\Okta\Application\ApplicationSignOnMode $signOnMode) : BasicAuthApplication
    {
        $this->setResourceProperty(
            self::SIGN_ON_MODE,
            $signOnMode
     ...
     * @return self
     */
    function setVisibility(\Okta\Application\ApplicationVisibility $visibility) : BasicAuthApplication
    {
        $this->setResourceProperty(
            self::VISIBILITY,
            $visibility
     ...
     * @return \Okta\Application\BasicApplicationSettings
     */
    function getSettings(array $options = []) : \Okta\Application\BasicApplicationSettings
    {
        return $this->getResourceProperty(
            self::SETTINGS,
            \Okta\Application\BasicApplicationSettings::class,
            $options
        );
    }
