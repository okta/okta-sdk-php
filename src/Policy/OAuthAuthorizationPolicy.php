...
class OAuthAuthorizationPolicy extends \Okta\Policy\Policy
{
    /**
     * Set the Conditions.
     *
     ...
     * @return self
     */
    function setConditions(\Okta\Policy\PolicyRuleConditions $conditions) : OAuthAuthorizationPolicy
    {
     ...
     * @return self
     */
    function setDescription($description) : OAuthAuthorizationPolicy
    {
        $this->setProperty(
            self::DESCRIPTION,
            $description
     ...
     * @return self
     */
    function setName($name) : OAuthAuthorizationPolicy
    {
        $this->setProperty(
            self::NAME,
            $name
     ...
     * @return self
     */
    function setPriority($priority) : OAuthAuthorizationPolicy
    {
        $this->setProperty(
            self::PRIORITY,
            $priority
     ...
     * @return self
     */
    function setStatus($status) : OAuthAuthorizationPolicy
    {
        $this->setProperty(
            self::STATUS,
            $status
     ...
     * @return self
     */
    function setSystem($system) : OAuthAuthorizationPolicy
    {
        $this->setProperty(
            self::SYSTEM,
            $system
