...
class EventHook extends \Okta\Resource\AbstractResource
{
     ...
     * Success
     */
    function create() : \Okta\EventHook\EventHook 
    {
        ...
        $body = $this
                ...
                ->setRequestBody($this)
                ->executeRequest();
        return new \Okta\EventHook\EventHook(null, $body);
    }
    /**
     * Success
     */
    function read($eventHookId) : \Okta\EventHook\EventHook 
    {
        $uri = $this->getDataStore()->buildUri(
     ...
     * Success
     */
    function update() : \Okta\EventHook\EventHook 
    {
        $uri = $this->getDataStore()->buildUri(
            "/api/v1/eventHooks/".$this->id.""
        );
        $body = $this
                ->getDataStore()
     ...
     * Success
     */
    function activate() : \Okta\EventHook\EventHook 
    {
        $uri = $this->getDataStore()->buildUri(
            "/api/v1/eventHooks/".$this->id."/lifecycle/activate"
        );
        $body = $this
                ->getDataStore()
                ->setRequestMethod("POST")
     ...
     * Success
     */
    function deactivate() : \Okta\EventHook\EventHook 
    {
        $uri = $this->getDataStore()->buildUri(
            "/api/v1/eventHooks/".$this->id."/lifecycle/deactivate"
        );
        $body = $this
                ->getDataStore()
                ->setRequestMethod("POST")
     ...
     * Success
     */
    function verify() : \Okta\EventHook\EventHook 
    {
        $uri = $this->getDataStore()->buildUri(
            "/api/v1/eventHooks/".$this->id."/lifecycle/verify"
        );
        $body = $this
                ->getDataStore()
                ->setRequestMethod("POST")
