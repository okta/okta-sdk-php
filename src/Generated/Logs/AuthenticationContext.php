...
class AuthenticationContext extends \Okta\Resource\AbstractResource
{
    const ISSUER = 'issuer';
     ...
     * Get the issuer.
     *
     * @return \Okta\Logs\Issuer
     */
    public function getIssuer(array $options = []): \Okta\Logs\Issuer
    {
        return $this->getResourceProperty(
            self::ISSUER,
            \Okta\Logs\Issuer::class,
            $options
        );
    }
