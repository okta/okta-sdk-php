...
class SecurePasswordStoreApplication extends \Okta\Applications\Application
{
     ...
     * Get the settings.
     *
     * @return \Okta\Applications\SecurePasswordStoreApplicationSettings
     */
    public function getSettings(array $options = []): \Okta\Applications\SecurePasswordStoreApplicationSettings
    {
        return $this->getResourceProperty(
            self::SETTINGS,
            \Okta\Applications\SecurePasswordStoreApplicationSettings::class,
            $options
        );
    }
     ...
     * Set the settings.
     *
     * @param \Okta\Applications\SecurePasswordStoreApplicationSettings $settings The SecurePasswordStoreApplicationSettings instance.
     * @return self
     */
    public function setSettings(SecurePasswordStoreApplicationSettings $settings)
    {
