...
class OpenIdConnectApplicationSettings extends \Okta\Applications\ApplicationSettings
{
     ...
     * Get the oauthClient.
     *
     * @return \Okta\Applications\OpenIdConnectApplicationSettingsClient
     */
    public function getOauthClient(array $options = []): \Okta\Applications\OpenIdConnectApplicationSettingsClient
    {
        return $this->getResourceProperty(
            self::OAUTH_CLIENT,
            \Okta\Applications\OpenIdConnectApplicationSettingsClient::class,
            $options
        );
    }
