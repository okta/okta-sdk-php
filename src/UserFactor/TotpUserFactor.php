...
class TotpUserFactor extends \Okta\UserFactor\UserFactor
{
     ...
     * @return self
     */
    function setProfile(\Okta\UserFactor\TotpUserFactorProfile $profile) : TotpUserFactor
    {
     ...
     * @return self
     */
    function setFactorType(\Okta\UserFactor\FactorType $factorType) : TotpUserFactor
    {
     ...
     * @return self
     */
    function setProvider(\Okta\UserFactor\FactorProvider $provider) : TotpUserFactor
    {
        $this->setEnumProperty(
            self::PROVIDER,
            $provider
     ...
     * @return self
     */
    function setVerify(\Okta\UserFactor\VerifyFactorRequest $verify) : TotpUserFactor
    {
        $this->setResourceProperty(
            self::VERIFY,
            $verify
     ...
     * @return \Okta\UserFactor\TotpUserFactorProfile
     */
    function getProfile(array $options = []) : \Okta\UserFactor\TotpUserFactorProfile
    {
        return $this->getResourceProperty(
            self::PROFILE,
            \Okta\UserFactor\TotpUserFactorProfile::class,
            $options
        );
    }
