...
class U2fUserFactor extends \Okta\UserFactor\UserFactor
{
     ...
     * @return self
     */
    function setProfile(\Okta\UserFactor\U2fUserFactorProfile $profile) : U2fUserFactor
    {
     ...
     * @return self
     */
    function setFactorType(\Okta\UserFactor\FactorType $factorType) : U2fUserFactor
    {
     ...
     * @return self
     */
    function setProvider(\Okta\UserFactor\FactorProvider $provider) : U2fUserFactor
    {
        $this->setEnumProperty(
            self::PROVIDER,
            $provider
     ...
     * @return self
     */
    function setVerify(\Okta\UserFactor\VerifyFactorRequest $verify) : U2fUserFactor
    {
        $this->setResourceProperty(
            self::VERIFY,
            $verify
     ...
     * @return \Okta\UserFactor\U2fUserFactorProfile
     */
    function getProfile(array $options = []) : \Okta\UserFactor\U2fUserFactorProfile
    {
        return $this->getResourceProperty(
            self::PROFILE,
            \Okta\UserFactor\U2fUserFactorProfile::class,
            $options
        );
    }
