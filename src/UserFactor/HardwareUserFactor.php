...
class HardwareUserFactor extends \Okta\UserFactor\UserFactor
{
     ...
     * @return self
     */
    function setProfile(\Okta\UserFactor\HardwareUserFactorProfile $profile) : HardwareUserFactor
    {
     ...
     * @return self
     */
    function setFactorType(\Okta\UserFactor\FactorType $factorType) : HardwareUserFactor
    {
        $this->setResourceProperty(
            self::FACTOR_TYPE,
            $factorType
     ...
     * @return self
     */
    function setProvider(\Okta\UserFactor\FactorProvider $provider) : HardwareUserFactor
    {
        $this->setResourceProperty(
            self::PROVIDER,
            $provider
     ...
     * @return self
     */
    function setVerify(\Okta\UserFactor\VerifyFactorRequest $verify) : HardwareUserFactor
    {
        $this->setResourceProperty(
            self::VERIFY,
            $verify
     ...
     * @return \Okta\UserFactor\HardwareUserFactorProfile
     */
    function getProfile(array $options = []) : \Okta\UserFactor\HardwareUserFactorProfile
    {
        return $this->getResourceProperty(
            self::PROFILE,
            \Okta\UserFactor\HardwareUserFactorProfile::class,
            $options
        );
    }
