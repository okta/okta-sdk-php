...
class CallUserFactor extends \Okta\UserFactor\UserFactor
{
     ...
     * @return self
     */
    function setProfile(\Okta\UserFactor\CallUserFactorProfile $profile) : CallUserFactor
    {
     ...
     * @return self
     */
    function setFactorType(\Okta\UserFactor\FactorType $factorType) : CallUserFactor
    {
        $this->setResourceProperty(
            self::FACTOR_TYPE,
            $factorType
     ...
     * @return self
     */
    function setProvider(\Okta\UserFactor\FactorProvider $provider) : CallUserFactor
    {
        $this->setResourceProperty(
            self::PROVIDER,
            $provider
     ...
     * @return self
     */
    function setVerify(\Okta\UserFactor\VerifyFactorRequest $verify) : CallUserFactor
    {
        $this->setResourceProperty(
            self::VERIFY,
            $verify
     ...
     * @return \Okta\UserFactor\CallUserFactorProfile
     */
    function getProfile(array $options = []) : \Okta\UserFactor\CallUserFactorProfile
    {
        return $this->getResourceProperty(
            self::PROFILE,
            \Okta\UserFactor\CallUserFactorProfile::class,
            $options
        );
    }
