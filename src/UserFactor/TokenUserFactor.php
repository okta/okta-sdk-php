...
class TokenUserFactor extends \Okta\UserFactor\UserFactor
{
     ...
     * @return self
     */
    function setProfile(\Okta\UserFactor\TokenUserFactorProfile $profile) : TokenUserFactor
    {
     ...
     * @return self
     */
    function setFactorType(\Okta\UserFactor\FactorType $factorType) : TokenUserFactor
    {
     ...
     * @return self
     */
    function setProvider(\Okta\UserFactor\FactorProvider $provider) : TokenUserFactor
    {
        $this->setEnumProperty(
            self::PROVIDER,
            $provider
     ...
     * @return self
     */
    function setVerify(\Okta\UserFactor\VerifyFactorRequest $verify) : TokenUserFactor
    {
        $this->setResourceProperty(
            self::VERIFY,
            $verify
     ...
     * @return \Okta\UserFactor\TokenUserFactorProfile
     */
    function getProfile(array $options = []) : \Okta\UserFactor\TokenUserFactorProfile
    {
        return $this->getResourceProperty(
            self::PROFILE,
            \Okta\UserFactor\TokenUserFactorProfile::class,
            $options
        );
    }
