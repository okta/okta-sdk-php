...
class CustomHotpUserFactor extends \Okta\UserFactor\UserFactor
{
    const PROFILE = 'profile';
    const FACTOR_PROFILE_ID = 'factorProfileId';
     ...
     * @return self
     */
    function setProfile(\Okta\UserFactor\CustomHotpUserFactorProfile $profile) : CustomHotpUserFactor
    {
    ...
    /**
     * Set the FactorProfileId.
     *
     * @param mixed $factorProfileId The factorProfileId to set.
     * @return self
     */
    function setFactorProfileId($factorProfileId) : CustomHotpUserFactor
    {
        $this->setProperty(
            self::FACTOR_PROFILE_ID,
            $factorProfileId
        );
     ...
     * @return self
     */
    function setFactorType(\Okta\UserFactor\FactorType $factorType) : CustomHotpUserFactor
    {
     ...
     * @return self
     */
    function setProvider(\Okta\UserFactor\FactorProvider $provider) : CustomHotpUserFactor
    {
        $this->setEnumProperty(
            self::PROVIDER,
            $provider
     ...
     * @return self
     */
    function setVerify(\Okta\UserFactor\VerifyFactorRequest $verify) : CustomHotpUserFactor
    {
        $this->setResourceProperty(
            self::VERIFY,
            $verify
     ...
     * @return \Okta\UserFactor\CustomHotpUserFactorProfile
     */
    function getProfile(array $options = []) : \Okta\UserFactor\CustomHotpUserFactorProfile
    {
        return $this->getResourceProperty(
            self::PROFILE,
            \Okta\UserFactor\CustomHotpUserFactorProfile::class,
            $options
        );
    }

    /**
     * Get the FactorProfileId.
     *
     * @param mixed $factorProfileId The factorProfileId to set.
     * @return string
     */
    function getFactorProfileId() : string
    {
