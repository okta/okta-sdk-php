...
class WebAuthnUserFactor extends \Okta\UserFactor\UserFactor
{
     ...
     * @return self
     */
    function setProfile(\Okta\UserFactor\WebAuthnUserFactorProfile $profile) : WebAuthnUserFactor
    {
     ...
     * @return self
     */
    function setFactorType(\Okta\UserFactor\FactorType $factorType) : WebAuthnUserFactor
    {
        $this->setResourceProperty(
            self::FACTOR_TYPE,
            $factorType
     ...
     * @return self
     */
    function setProvider(\Okta\UserFactor\FactorProvider $provider) : WebAuthnUserFactor
    {
        $this->setResourceProperty(
            self::PROVIDER,
            $provider
     ...
     * @return self
     */
    function setVerify(\Okta\UserFactor\VerifyFactorRequest $verify) : WebAuthnUserFactor
    {
        $this->setResourceProperty(
            self::VERIFY,
            $verify
     ...
     * @return \Okta\UserFactor\WebAuthnUserFactorProfile
     */
    function getProfile(array $options = []) : \Okta\UserFactor\WebAuthnUserFactorProfile
    {
        return $this->getResourceProperty(
            self::PROFILE,
            \Okta\UserFactor\WebAuthnUserFactorProfile::class,
            $options
        );
    }
