...
class WebUserFactor extends \Okta\UserFactor\UserFactor
{
     ...
     * @return self
     */
    function setProfile(\Okta\UserFactor\WebUserFactorProfile $profile) : WebUserFactor
    {
     ...
     * @return self
     */
    function setFactorType(\Okta\UserFactor\FactorType $factorType) : WebUserFactor
    {
     ...
     * @return self
     */
    function setProvider(\Okta\UserFactor\FactorProvider $provider) : WebUserFactor
    {
        $this->setEnumProperty(
            self::PROVIDER,
            $provider
     ...
     * @return self
     */
    function setVerify(\Okta\UserFactor\VerifyFactorRequest $verify) : WebUserFactor
    {
        $this->setResourceProperty(
            self::VERIFY,
            $verify
     ...
     * @return \Okta\UserFactor\WebUserFactorProfile
     */
    function getProfile(array $options = []) : \Okta\UserFactor\WebUserFactorProfile
    {
        return $this->getResourceProperty(
            self::PROFILE,
            \Okta\UserFactor\WebUserFactorProfile::class,
            $options
        );
    }
